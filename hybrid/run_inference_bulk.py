...
DEPTH_CKPT = "/home/albus/Documents/AureliusIndustries/miracle/best_depth_teacher.pth"
SEG_CKPT = "/home/albus/Documents/AureliusIndustries/miracle/best_seg_teacher.pth"
...
def depth_to_rgb(depth_tensor: torch.Tensor) -> np.ndarray:
    ...
    if d_max <= d_min + 1e-6:
        ...
        d_norm = 1.0 - (d - d_min) / (d_max - d_min + 1e-6)
...
def run_inference(frame: np.ndarray, depth_model, seg_model) -> tuple:
    ...
    with torch.no_grad():
        ...
        depth_map = (depth_pred[0, 0] if depth_pred.ndim == 4 else depth_pred[0]) * 200.0
